<!-- Sidebar  -->
        <nav id="sidebar">
            <div class="sidebar-header">
                <img src="../resources/dashboardLogo.png" class="img-fluid" />
            </div>
            <ul class="list-unstyled components">
                <li class="active">
                    <a href="dashboard.php" class="dashboard"><i class="material-icons">home</i><span>Home</span></a>
                </li>
                ...
                <li class="dropdown">
                    <a href="#homeSubmenu1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                        <i class="material-icons">aspect_ratio</i><span>Registros</span></a>
                    <ul class="collapse list-unstyled menu" id="homeSubmenu1">
                        <li>
                            <a href="registrosAdoptantes.php">Adoptantes</a>
                        </li>
                        <li>
                            <a href="registrosMascotas.php">Mascotas</a>
                        </li>
                        <li>
                            <a href="#">Usuarios</a>
                        </li>
