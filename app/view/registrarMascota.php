                        ...
                        <div class="card" style="min-height: 485px">
                            <div class="col">
                                ...
                                <div class="container pb-4">
                                  <form method="post" action="../model/registrarMascota.php" id="registrarMascota" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row py-3 px-2">
                                      <div class="col-md-12">
                                        <button type="submit" name="submit" class="btn btn-success btn-block w-100">Registrar</button>
                                      </div>
                                    </div>
                                </form>
                                </div>
